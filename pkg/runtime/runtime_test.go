...
func (m *mockRuntime) EnsureDirectory(_ context.Context, _ string) error         { return nil }
func (m *mockRuntime) FileExists(_ context.Context, _ string) (bool, error)      { return true, nil }
